...
HXLINE(  12)		this->serverStartedText =  ::flixel::text::FlxText_obj::__alloc( HX_CTX ,0,0,500,null(),null(),null());
HXLINE(  13)		this->serverStartedText->set_text(HX_("Server started!",9d,dc,aa,93));
HXLINE(  14)		this->add(this->serverStartedText);
...
void PlayState_obj::__Mark(HX_MARK_PARAMS)
{
	...
	HX_MARK_MEMBER_NAME(serverStartedText,"serverStartedText");
...
{
	HX_VISIT_MEMBER_NAME(serverStartedText,"serverStartedText");
...
::hx::Val PlayState_obj::__Field(const ::String &inName,::hx::PropertyAccess inCallProp)
{
	...
	case 6:
		...
		break;
	case 17:
		if (HX_FIELD_EQ(inName,"serverStartedText") ) { return ::hx::Val( serverStartedText ); }
	}
...
::hx::Val PlayState_obj::__SetField(const ::String &inName,const ::hx::Val &inValue,::hx::PropertyAccess inCallProp)
{
	switch(inName.length) {
	case 17:
		if (HX_FIELD_EQ(inName,"serverStartedText") ) { serverStartedText=inValue.Cast<  ::flixel::text::FlxText >(); return inValue; }
	}
...
{
	outFields->push(HX_("serverStartedText",8b,64,1e,9f));
	super::__GetFields(outFields);
};

#ifdef HXCPP_SCRIPTABLE
static ::hx::StorageInfo PlayState_obj_sMemberStorageInfo[] = {
	{::hx::fsObject /*  ::flixel::text::FlxText */ ,(int)offsetof(PlayState_obj,serverStartedText),HX_("serverStartedText",8b,64,1e,9f)},
	{ ::hx::fsUnknown, 0, null()}
};
...
static ::String PlayState_obj_sMemberFields[] = {
	HX_("serverStartedText",8b,64,1e,9f),
