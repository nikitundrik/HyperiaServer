...
class ApplicationMain
{
	...
	{
		lime.system.System.__registerEntryPoint("HyperiaServer", create);

		#if (js && html5)
		#if (munit || utest)
		lime.system.System.embed("HyperiaServer", null, 640, 480);
		#end
		#else
		create(null);
		#end
	...
	public static function create(config):Void
	{
		...
		app.meta["file"] = "HyperiaServer";
		app.meta["name"] = "HyperiaServer";
